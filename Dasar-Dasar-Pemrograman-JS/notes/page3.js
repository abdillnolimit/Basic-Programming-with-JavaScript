...
Prompt menyampaikan pesan sekaligus mengambil data dari user. Pada prompt, tipe data yang diambil adalah string.
...
tipe data yang diperoleh dari user berupa boolean. Button 'ok' bermakna true, sedangkan 'cancel' bermakna false.
